...
module.exports.createApplication = function(app, model, config, callback) {
    ...
    Step(
        ...
        function loadLibraries() {
            ...
            app.libs["amd-loader"] = require("amd-loader");
            var public_root = config.paths.public_root || "./public";
            app.require_public = function(moduleName) {
                return require(path.join(public_root, moduleName));
            };
                    ...
                    case "string":
                        switch(middleware) {
                            ...
                            case "favicon":
                                ...
                                break;
                            default:
                                app.express.use(express[middleware](config[middleware]));
                        }
                        break;
                    default:
